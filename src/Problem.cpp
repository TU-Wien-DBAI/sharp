...
namespace sharp
{
	...
	{
		return this->calculateSolutionFromDecomposition(algorithm, this->calculateHypertreeDecomposition());
	}

	Solution *Problem::calculateSolutionFromDecomposition(AbstractHTDAlgorithm *algorithm, ExtendedHypertree *root)
	{
